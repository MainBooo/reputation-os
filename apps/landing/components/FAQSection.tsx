...
const faqs = [
  {
    question: 'Что такое ReputationOS?',
    answer: 'ReputationOS — онлайн-сервис для мониторинга отзывов, упоминаний и репутации компаний. Пользователь оплачивает доступ к личному кабинету сервиса, аналитике, уведомлениям и инструментам работы с отзывами. Подписка оформляется на выбранный тариф: Старт (990 ₽/мес), Бизнес (2 990 ₽/мес) или Агентство (6 990 ₽/мес).'
  },
  {
