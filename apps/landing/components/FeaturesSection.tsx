  ...
  return (
    <section id="features" className="relative z-10 mx-auto w-full max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto mb-12 max-w-3xl text-center">
        <span className="mb-4 block text-sm font-semibold uppercase tracking-[0.32em] text-cyan-300">
          Возможности
        </span>

        <h2 className="text-[clamp(34px,4.4vw,56px)] font-semibold leading-tight tracking-[-0.05em] text-white">
