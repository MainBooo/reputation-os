...
const ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'note', value: 'Веб-мониторинг доступен на тарифах PRO и AGENCY. На тарифах FREE и START он недоступен.' },
  ...
  },
  {
    ...
    category: 'ai',
    content: [
      { type: 'text', value: 'Количество AI-ответов учитывается в пределах календарного месяца.' },
      { type: 'steps', items: [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'tip', value: 'Telegram-уведомления доступны на тарифах PRO и AGENCY.' },
      { type: 'link', label: 'Настройки уведомлений', href: '/settings' },
    ],
  },
